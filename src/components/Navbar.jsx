        ...
        <nav className='bg-[#040a0e] flex justify-between items-center py-2'>
            ...
            <ul className='flex gap-2 px-5 justify-center items-center'>
                <SignedOut>
                    ...
                    <SignUpButton>
                        <button className="hidden relative sm:inline-flex items-center justify-center p-0.5  me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-green-400 to-blue-600 group-hover:from-green-400 group-hover:to-blue-600 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800">
